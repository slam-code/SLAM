...
def run(param):
    myrobot = robot()
    myrobot.set(0.0, 1.0, 0.0) #从(0,1)出发，向x方向前进，朝y=0靠近.
    ...
    # Enter code here
    #  
        crosstrack_error=myrobot.y    #到y=0的距离
        steer=param*crosstrack_error  #轮子方向，比例控制器，控制移动的方位。
        myrobot=myrobot.move(steer,speed)#根据steer的方位move speed 长度。
        print( myrobot, steer )
