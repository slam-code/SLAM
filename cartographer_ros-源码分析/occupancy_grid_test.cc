...
TEST(OccupancyGridTest, ComputeMapLimits) {
  ...
  const ::cartographer::mapping::TrajectoryNode::ConstantData constant_data{//ConstantData构造函数
  ...
  const ::cartographer::mapping::TrajectoryNode trajectory_node{          //TrajectoryNode构造函数
