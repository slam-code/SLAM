...
不同轨迹线的连通性问题.
TrajectoryConnectivity类不可拷贝/赋值
包含3个数据成员
1,互斥锁lock_
...
// Returns a proto encoding connected components.已联通成分
proto::TrajectoryConnectivity ToProto(
    std::vector<std::vector<int>> connected_components);

// Returns the connected component containing 'trajectory_index'. 由联通id组成的联通分量
