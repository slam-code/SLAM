...
if("FALSE" STREQUAL "TRUE")
  set(robot_setup_tf_SOURCE_PREFIX /media/shen/onlyu/githubcollect/google_SLAM_cartographer/ros_start/src/robot_setup_tf)
  set(robot_setup_tf_DEVEL_PREFIX /media/shen/onlyu/githubcollect/google_SLAM_cartographer/ros_start/devel)
  ...
  set(robot_setup_tf_INSTALL_PREFIX /media/shen/onlyu/githubcollect/google_SLAM_cartographer/ros_start/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'robot_setup_tf' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'shen <shen@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'robot_setup_tf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/media/shen/onlyu/githubcollect/google_SLAM_cartographer/ros_start/install/${idir}'.  Ask the maintainer 'shen <shen@todo.todo>' to fix it.")
    endif()
